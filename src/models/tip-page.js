    ...
    blocks: {
      ...
      default: [
        ...
        },
        {
          ...
          tip_card: {
            className:
              "bg-white border-2 border-black rounded-xl shadow-[2px_2px_0px_0px_rgba(0,0,0,0.6)] p-0 max-w-sm",
            data: {
              background_image:
                "https://res.cloudinary.com/dspp405ug/image/upload/v1761342822/pp-uploads/vk3fkqzgcokbbyxxpxfr.jpg",
              primary_color: "#000000",
              secondary_color: "#ff8181",
              text_color: "#ff0000",
            },
            template:
